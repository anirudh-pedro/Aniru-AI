            ...
            <div className="flex flex-wrap gap-2">
              {quickActions.map((action, index) => (
                <motion.button
                  ...
                  className="px-3 py-1.5 bg-gray-800 border border-gray-700 rounded-full text-sm text-gray-300 hover:bg-gray-700 hover:text-cyan-400 hover:border-cyan-500/50 transition-all duration-200"
                >
        ...
        <div className="p-6 bg-gray-800 border-t border-gray-700">
          <form onSubmit={handleSendMessage} className="flex space-x-3">
            ...
            <motion.button
              ...
              className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-xl hover:from-cyan-600 hover:to-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center space-x-2 shadow-lg shadow-cyan-500/25"
            >
